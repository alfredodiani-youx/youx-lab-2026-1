#16:04 Minha dificuldade até agora é criar a nova chave e colocar na lista
funcionarios = [
...
novo_salario = []
#funcionarios[(int("novo_salario"))] = novo_salario
for c in funcionarios:
    if c['anos_trabalhados'] >= 6:
        novo_salario = ((c["Salario"] * 20) / 100) + c["Salario"]

        #funcionarios += [{'novo_salario': novo_salario}]
    else:
