#.append(algo) <-- adiciona algo a lista
...
#.sort(reverse= True) <-- numeros na ordem reversa
#variavel= [valores que escolheu]
# {len(variavel)} <-- mostra o quanto de numeros tem na lista
