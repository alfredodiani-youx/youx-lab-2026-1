# Mais de 5 anos trabalhados → aumento de 20%.
# 5 anos ou menos → aumento de 10%.

# O que você deve fazer

# Percorrer a lista funcionarios com um for.
#Para cada funcionário, calcular o novo salário de acordo com a regra.
#Criar uma nova chave na lista funcionarios, onde cada item será um dicionário no formato:
